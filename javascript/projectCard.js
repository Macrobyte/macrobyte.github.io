...
export function createProjectCard(project) {
  ...
  <p class="project-meta">
    ${durationSVG} <span class="${durationClass}">${project.duration}</span>
    <span class="sep">|</span> 
...
`;
  ...
  // Check if project has any modal content (video tag is for thumbnail only)
  const hasModalContent = project.modal && Object.keys(project.modal).length > 0;
